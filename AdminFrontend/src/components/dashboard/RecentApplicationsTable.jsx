  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
      <div className="flex items-center justify-between p-6 border-b border-gray-50">
        ...
        <button className="text-xs font-bold text-[#22C55E] hover:underline cursor-pointer">View all</button>
      </div>
              ...
              {applications.map((app, idx) => (
                <tr key={idx} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="px-6 py-3.5 text-right">
                    <button className="text-xs font-bold text-green-600 hover:text-emerald-800 bg-emerald-50/50 hover:bg-emerald-50 border border-emerald-100/30 px-2.5 py-1 rounded transition-colors cursor-pointer">
                      View
                    </button>
                  </td>
                </tr>
