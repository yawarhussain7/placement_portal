    ...
    return (
        ...
        >
            <form onSubmit={handleSubmit} className="space-y-1">
                ...
                <div className={`mt-2 ${!formData.password ? 'invisible' : ''}`}>
                ...
                <button
                    type="submit"
                    className="cursor-pointer w-full mt-2 bg-[#22C55E] text-white py-2 px-4 rounded-lg font-medium text-sm hover:bg-[#16A34A] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#22C55E] transition-colors"
                >
                    Sign Up
                </button>
