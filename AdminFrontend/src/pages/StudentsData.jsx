        ...
        <main className="flex-1 p-8 space-y-6 overflow-y-auto max-w-[1600px] w-full mx-auto custom-scrollbar">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-100 pb-2">
            <div>
              ...
              <p className="text-xs font-medium text-gray-400 mt-0.5">Manage and track all enrolled students</p>
            </div>
            ...
            <div className="flex items-center gap-2.5 self-end md:self-auto w-full md:w-auto">
              <div className="relative flex-1 md:flex-none">
                ...
                <input 
                  ...
                  className="w-full md:w-56 bg-white pl-8 pr-3 py-2 border border-gray-200 rounded-lg text-xs font-medium text-gray-800 focus:outline-none focus:border-emerald-500 transition-colors shadow-sm"
                />
              </div>
              ...
              <select 
                ...
                className="px-3 py-2 bg-white border border-gray-200 rounded-lg text-xs font-bold text-gray-500 focus:outline-none focus:border-emerald-500 transition-colors cursor-pointer shadow-sm"
              >
              ...
              <button className="px-3 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-lg transition-colors flex items-center gap-1.5 shrink-0 shadow-sm shadow-emerald-500/10">
                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
