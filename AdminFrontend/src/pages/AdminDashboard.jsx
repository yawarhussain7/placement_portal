...
import { getTotalStudents } from '../api/dashboard.js';
      ...
      try {
        ...
        if (response.data && response.data.data) {
          setStats({
            ...
            totalApplications: response.data.data.totalApplications || '0',
            placedStudents: response.data.data.placedStudents || '0',
            partnerCompanies: response.data.data.partnerCompanies || '0',
            recentApplications: response.data.data.recentApplications || [],
            pipelineData: response.data.data.pipelineData || []
          });
        }
      } catch (err) {
          ...
          <div className="max-w-[1600px] mx-auto space-y-8 animate-in fade-in duration-300">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <button className="flex items-center gap-2 px-4 py-2 bg-emerald-600 rounded-lg text-xs font-bold text-white hover:bg-emerald-700 transition-all shadow-md cursor-pointer">
