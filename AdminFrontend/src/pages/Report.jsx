...
const MOCK_STATS = [
  { id: 1, label: 'Placement Rate', value: '76%', change: '+4.2%', icon: FiPercent },
  { id: 2, label: 'Avg. CTC (LPA)', value: '12.4', change: '+2.1', icon: FiDollarSign },
  { id: 3, label: 'Highest CTC (LPA)', value: '45.0', change: '+8.5', icon: FiAward },
  { id: 4, label: 'Companies Visited', value: '134', change: '+22', icon: FiBriefcase },
];

const MOCK_MONTHS = [
  { month: 'Aug', value: 12 }, { month: 'Sep', value: 34 }, { month: 'Oct', value: 58 },
  { month: 'Nov', value: 95 }, { month: 'Dec', value: 142 }, { month: 'Jan', value: 188 }, { month: 'Feb', value: 231 },
];

const MOCK_DEPT = [
  { dept: 'CSE', count: 340, percentage: 81 }, { dept: 'IT', count: 210, percentage: 75 },
  { dept: 'ECE', count: 160, percentage: 70 }, { dept: 'MBA', count: 95, percentage: 73 }, { dept: 'MCA', count: 67, percentage: 74 },
];

const MOCK_OVERVIEW_DATA = [
  { rank: '01', hired: 124, ctc: '7.2 LPA', share: 14 },
  { rank: '02', hired: 98, ctc: '8.0 LPA', share: 11 },
  { rank: '03', hired: 18, ctc: '32.0 LPA', share: 2 },
  { rank: '04', hired: 22, ctc: '28.0 LPA', share: 3 },
  { rank: '05', hired: 55, ctc: '14.0 LPA', share: 6 },
];
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-8 space-y-8 max-w-[1600px] w-full mx-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button className="flex items-center gap-2 px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-bold rounded-lg transition-all shadow-md active:scale-95">
                ...
                {MOCK_MONTHS.map((m, i) => (
                  <div key={i} className="flex flex-col items-center flex-1 gap-3">
                    <div className="w-full bg-slate-100 rounded-t-lg relative group flex items-end justify-center" style={{ height: '100%' }}>
                      <div className="w-full bg-emerald-500 rounded-t-sm transition-all duration-500 group-hover:bg-emerald-600" style={{ height: `${(m.value/231)*100}%` }} />
                    </div>
