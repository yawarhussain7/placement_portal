...
import { FormInput, FormSelect } from '../../components/Dashboard/FormSelect'

export default function PersonalDetailsForm({ formData, onInputChange, onNext, onBack, step }) {
  return (
    <form onSubmit={(e) => { e.preventDefault(); onNext?.(); }} className="bg-white border border-slate-100 rounded-2xl p-6 md:p-8 shadow-sm">
